...
export const Navbar = ({ clickState, setClickState }) => {
  ...
  const elementClassLookupArray = [
    "headerBarMenuElement",
    "headerBarMenuElementBold",
  ];
  //Commented out for Netlify
      ...
      <div className="headerBarMenu">
        ...
        <div className="headerBarMenuInner2">
          <div
            ...
            className={elementClassLookupArray[clickState[0]]}
          >
            Home
          </div>
          <div>•</div>
          <a href={CVpdf}>
            <div className={elementClassLookupArray[clickState[1]]}>CV</div>
          </a>
          <div>•</div>
          <div
            onClick={() => {
            ...
            className={elementClassLookupArray[clickState[2]]}
          >
            Skills
          </div>
          <div>•</div>
          <div
            ...
            className={elementClassLookupArray[clickState[3]]}
          >
            Experience
          </div>
